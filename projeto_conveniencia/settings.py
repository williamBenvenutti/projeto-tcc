"""
Django settings for projeto_conveniencia project.
...
SECRET_KEY = 'django-insecure-97w-=+d33jpf)#nu=z^6nkfv6_#nee3#2(cg-&!mqrjzk_mofr'
...
ROOT_URLCONF = 'projeto_conveniencia.urls'
...
WSGI_APPLICATION = 'projeto_conveniencia.wsgi.application'
